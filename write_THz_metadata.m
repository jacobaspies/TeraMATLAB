...
%   gloabl variables, but that has not been done in this implementation.

function write_THz_metadata(lock_in,memo,N_avg,tc_to_wait,N_samples,iterations,start_time,zaber_position)

    subdir = datestr(now,'yyyy_mm_dd');
    dir = "C:\Data\" + subdir + "\";
    
    for i = 1:9999
        % Maximum of 999 data saves per day, could expand this if needed.
